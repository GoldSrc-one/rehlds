...
<li>sv_use_steam_networking &lt;1|0&gt; // Use Steam Datagram Relay (FakeIP) for server networking. Must be set on the command line (+sv_use_steam_networking 1). Default: 0
</ul>
</details>
