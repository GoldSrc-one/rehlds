...
#define _STEAM_CALLBACK_3( extra_code, thisclass, func, param ) \
	struct CCallbackInternal_ ## func : private CCallbackImpl< sizeof( param ) > { \
		CCallbackInternal_ ## func () { extra_code STEAM_REGISTER_CALLBACK( this, param::k_iCallback ); } \
		CCallbackInternal_ ## func ( const CCallbackInternal_ ## func & ) { extra_code STEAM_REGISTER_CALLBACK( this, param::k_iCallback ); } \
...
inline void CCallback< T, P, bGameserver >::Register( T *pObj, func_t func )
{
	...
	STEAM_REGISTER_CALLBACK( this, P::k_iCallback );
}
...
inline void CCallback< T, P, bGameserver >::Unregister()
{
	...
	STEAM_UNREGISTER_CALLBACK( this );
}
