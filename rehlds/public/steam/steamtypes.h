...
// ReHLDS already defines these in public/rehlds/archtypes.h (included first
// via precompiled.h); skip ours to avoid redefinition clashes. The types are
// ABI-identical (1/2/4/8-byte ints), only the spelling differs (__int8 vs
// signed char on Windows, char vs signed char on Linux).
#ifndef ARCHTYPES_H
typedef unsigned char uint8;
