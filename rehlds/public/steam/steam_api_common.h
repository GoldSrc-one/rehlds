...
#ifdef REHLDS_SELF
void Rehlds_SteamAPI_RegisterCallback( class CCallbackBase *pCallback, int iCallback );
void Rehlds_SteamAPI_UnregisterCallback( class CCallbackBase *pCallback );
#define STEAM_REGISTER_CALLBACK Rehlds_SteamAPI_RegisterCallback
#define STEAM_UNREGISTER_CALLBACK Rehlds_SteamAPI_UnregisterCallback
#else
#define STEAM_REGISTER_CALLBACK SteamAPI_RegisterCallback
#define STEAM_UNREGISTER_CALLBACK SteamAPI_UnregisterCallback
#endif
...
public:
	...
	//ReHLDS addition for testsuite hooking support (was present in the old bundled SDK)
	...
	bool IsGameServer() { return (m_nCallbackFlags & k_ECallbackFlagsGameServer) != 0; }
...
{
public:
	virtual ~CCallbackImpl() { if ( m_nCallbackFlags & k_ECallbackFlagsRegistered ) STEAM_UNREGISTER_CALLBACK( this ); }
